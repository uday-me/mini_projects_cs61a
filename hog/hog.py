...
def free_bacon(score):
    ...
    trim_bound = score + 1
    new_pi = first_n_digits(pi, trim_bound)
    # END PROBLEM 2
    return new_pi % 10 + 3
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        current_player_score = free_bacon(opponent_score)
    else:
        current_player_score = roll_dice(num_rolls=num_rolls, dice=dice)
...
# def compute_gcd(player_score, opponent_score):
#     """Utility Function for computing the GCD of the player and opponent scores"""
#     if player_score > opponent_score:
#         smaller = opponent_score
#     else:
#         smaller = player_score
    ...
    def compute_gcd(player_score, opponent_score):
        ...
        for i in range(1, min_score + 1):
            if ((player_score % i == 0) and (opponent_score % i == 0)):
                gcd = i
        return gcd
    gcd = compute_gcd(player_score, opponent_score)
    if gcd >= 10:
        return True
    else:
        return False
...
def pig_pass(player_score, opponent_score):
    ...
    if player_score > opponent_score:
        return False
    elif (player_score < opponent_score) and (opponent_score - player_score) < 3:
        return True
    else:
        return False
    # END PROBLEM 4b
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if increase > running_high:
            print(f"{increase} point(s)! The most yet for Player {who}")
        return announce_highest(who=who, last_score=score, running_high=max(running_high, increase))
    return say
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=1000):
    ...
    def other_function(*args):
        ...
        for _ in range(trials_count):
            ...
            total += result
        averaged_res = total / trials_count
        return averaged_res
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    no_rolls = 0
    max_avg = 0
    for i in range(1, max_num_rolls+1):
        average_roll_dice = make_averaged(roll_dice, trials_count)
        turn_avg_score = average_roll_dice(i, dice)
        if turn_avg_score > max_avg:
            no_rolls = i
            max_avg = turn_avg_score
    return no_rolls
